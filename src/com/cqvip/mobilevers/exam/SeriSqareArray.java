...
public class SeriSqareArray<E> extends SparseArray<E> implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5653806084371768979L;

	
	 public SeriSqareArray(int capacity){
	        super(capacity);
	    }

	    public SeriSqareArray(){
	        super();
	    }
