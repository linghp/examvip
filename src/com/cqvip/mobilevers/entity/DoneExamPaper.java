...
public class DoneExamPaper implements Serializable{
	...
	public static List<DoneExamPaper> formList(JSONArray array)throws JSONException {
	...
	public static List<DoneExamPaper> formList(JSONObject json)throws JSONException {
