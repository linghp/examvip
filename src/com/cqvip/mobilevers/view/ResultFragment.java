...
public class ResultFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tx_testresult_time = (TextView) view.findViewById(R.id.tx_testresult_time);
		tx_testresult_totalcount = (TextView) view.findViewById(R.id.tx_testresult_totalcount);
		tx_testresult_percent = (TextView) view.findViewById(R.id.tx_testresult_percent);
		...
		tx_testresult_time.setText("考试用时："+formTime(examDoneInfo.getUseTime()));
		tx_testresult_totalcount.setText("试题总数：共"+baseExamInfo.getAllItemCount()+"道，"+"已做"+examDoneInfo.getDoneCount()+"道");
		tx_testresult_percent.setText("正确率："+getPercent(examDoneInfo.getRightCount(),examDoneInfo.getWrongCount())+"（答对"+
				examDoneInfo.getRightCount()+"道，答错"+examDoneInfo.getWrongCount()+"道）");
